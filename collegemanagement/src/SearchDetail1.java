...
class SearchDetail1 extends DBCON implements  WindowListener,ActionListener
{
	...
	SearchDetail1() throws Exception
	{
		f1 = new JFrame("View Detail Form");
		f1.setBounds(100,20,800,600);
		p1 = new JPanel();
		p1.setLayout(null);
		p1.setSize(800, 600);
		...
		{
			JOptionPane.showMessageDialog(f1,"Exception occured in this: "+ex);
		}
	...
	{
            try {
                SearchDetail1 cp = new SearchDetail1();
            } catch (Exception ex) {
                Logger.getLogger(SearchDetail1.class.getName()).log(Level.SEVERE, null, ex);
            }
	}
}